          ...
          <div className="about-content">
            ...
            <div className="about-text">
              ...
              <p>
                ...
                meaningful change in the lives of children, ensuring they have
            ...
            <div className="about-div2">
              ...
              <div className="about-div2-text">
                ...
                <p>
                  ...
                  education, healthcare, and safe living conditions. Together,
                  we create opportunities that pave the way for brighter
                  futures.{" "}
                </p>
                <br />
                <p>
            ...
            <div className="about-div3">
              <div className="about-div3-text">
                ...
                <p>
                  ...
                  and unwavering dedication to our mission, working tirelessly
                  to create a brighter future for those in need.
                </p>
                <br />
                <p>
                  Collaboration and determination drive us forward, ensuring
                  every child we serve receives the care, support, and
                  opportunities they deserve. Together, we face challenges
                  head-on and transform them into meaningful progress.
                </p>
                <br />
                <p>
            ...
            <div className="about-footer-bg">
              <div className="about-div4">
                ...
                <p className="div4-text">
                  ...
                  of children. Together, we can provide hope, opportunities, and
                  a brighter future filled with possibilities. Your support can
                  transform dreams into reality and make the world a better
